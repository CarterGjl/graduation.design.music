    ...
    private void initListeners() {
        ...
        mRecognitionListener = new RecognitionListener() {
            ...
            public void onRecognitionStart() {
                ...
                Message statusMsg = mHandler.obtainMessage(SHOW_MSG, CLEAR, 0, getString(R.string.recognition_start));
                mHandler.sendMessage(statusMsg);
            }
            ...
            public boolean onRecognitionResult(RecognitionResult recognitionResult) {
                ...
                Message resultMsg = mHandler.obtainMessage(SHOW_MSG, CLEAR, 0, getString(R.string.recognition_result) + result + getString(R.string.confidence) + recognitionResult.getConfidence());
                mHandler.sendMessage(resultMsg);
            ...
            public boolean onRecognitionError(String s) {
                ...
                Message errorMsg = mHandler.obtainMessage(SHOW_MSG, CLEAR, 0, getString(R.string.recognition_error) + s);
                mHandler.sendMessage(errorMsg);
        ...
        mEnableBeamFormSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                try {
                    ...
                    mEnableBeamFormSwitch.setText(b ? R.string.beamforming_enabled : R.string.beamforming_disabled);
                } catch (VoiceException e) {
                    Log.e(TAG, "Exception: ", e);
                }
            }
        ...
        mEnableSound.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                try {
                    mRecognizer.setSoundEnabled(isChecked);
                    Message sound = mHandler.obtainMessage(SHOW_MSG);
                    if (isChecked) {
                        sound.obj = "enable sounds";
                    } else {
                        sound.obj = "disable sounds";
                    }
                    mHandler.sendMessage(sound);
                    mEnableSound.setText(isChecked ? R.string.sound_enabled : R.string.sound_disabled);
                } catch (VoiceException e) {
                    Log.e(TAG, "Exception: ", e);
                }
            }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button_stop_recognition:
                showTip("stop waking up or recognizing");
            ...
            case R.id.button_stop_beam_forming:
                showTip("stop listening for beam forming");
                isBeamForming = false;
