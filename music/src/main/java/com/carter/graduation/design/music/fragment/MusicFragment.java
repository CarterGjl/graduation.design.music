...
public class MusicFragment extends Fragment {
    ...
    public MusicFragment(ArrayList<MusicInfo> musicInfos) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rvSongListView = view.findViewById(R.id.rv_song_list);
//        rvSongListView.setLayoutManager(new LinearLayoutManager(getActivity()));
//        rvSongListView.setAdapter(new MusicInfoAdapter(mMusicInfos));
        return view;
    }
